            ...
            <div class="col-12">
                ...
                <form class="form-horizontal mt-3" id="loginform" action="{{ \App\Helpers\UrlGen::login() }}" method="post">
                    ...
                    <div class="form-group text-center mt-4">
                        <div class="col-xs-12">
                            <button style="background-color: #53a4f3 !important;
    border-color: #53a4f3 !important;"class="btn btn-primary btn-lg btn-block waves-effect waves-light" type="submit">{{ trans('admin.login') }}</button>
                        </div>
                    </div>
                </form>
