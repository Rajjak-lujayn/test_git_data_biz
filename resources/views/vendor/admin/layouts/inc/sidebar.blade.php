        ...
        <div class="scroll-sidebar">
                    ...
                    @if (auth()->user()->can('post-list') ||
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link has-arrow waves-effect waves-dark">
                                <i data-feather="list"></i> <span class="hide-menu">{{ 'Listing' }}</span>
                            </a>
                            <ul aria-expanded="false" class="collapse first-level">
                                @if (auth()->user()->can('post-list') || userHasSuperAdminPermissions())
                                    <li class="sidebar-item">
                                        <a href="{{ admin_url('lists') }}" class="sidebar-link">
                                            <i class="mdi mdi-adjust"></i>
          ...
          <a href="{{ admin_url('categories') }}" class="sidebar-link">
           ...
           <span class="hide-menu">{{ trans('admin.categories') }}</span>
                                ...
                                @endif
                                <li class="sidebar-item">
                                    <a href="{{ admin_url('import_data') }}" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu">{{ 'Import Data' }}</span>
                                    </a>
                                </li>

                                {{-- changes by rajjak for add colum in admin list view--}}

                                <li class="sidebar-item">
                                    <a href="{{ admin_url('listingFileData') }}" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu">{{ 'File Data' }}</span>
                                    </a>
                                </li>
                                {{-- end --}}
          ...
          <a href="{{ admin_url('custom_fields') }}" class="sidebar-link">
           ...
           <span class="hide-menu">{{ trans('admin.custom fields') }}</span>
                    ...
                    @if (auth()->user()->can('user-list') ||
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link has-arrow waves-effect waves-dark">
                                <i data-feather="users" class="feather-icon"></i> <span
                                    class="hide-menu">{{ trans('admin.users') }}</span>
                            </a>
                            <ul aria-expanded="false" class="collapse first-level">
