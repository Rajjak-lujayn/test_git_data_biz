...
<head>
    ...
    <title>BiZB2B - Get lists</title>

    <style>
        /* .search-row-wrapper .row.m-0 select.form-control {
		...
		.sidebar-modern-inner.enable-long-words span.select2-selection li.select2-selection__choice {
        width: 100%;}
        .search-row-wrapper .row.m-0 span.select2.select2-container span.select2-selection {height: auto !important; }
.search-row-wrapper .row.m-0 span.select2.select2-container span.select2-selection li.select2-selection__choice {margin-bottom: 5px !important; }
