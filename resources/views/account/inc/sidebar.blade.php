					...
					<ul class="acc-list">
						<li>
							<a {!! ($pagePath=='') ? 'class="active"' : '' !!} href="{{ url('account') }}">
								<i class="icon-home"></i> Personal Details
							</a>
						</li>
						<li>
							<a {!! ($pagePath=='plans') ? 'class="active"' : '' !!} href="{{ url('plans') }}">
								<i class="fas fa-tags"></i> Credits
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="collapse-box">
				...
				<div class="panel-collapse collapse show" id="MyAds">
					...
					<!--	<li>
						...
						<li>
							<a{!! ($pagePath=='orders') ? ' class="active"' : '' !!} href="{{ url('account/orders') }}">
							<i class="icon-money"></i> My Orders&nbsp;
